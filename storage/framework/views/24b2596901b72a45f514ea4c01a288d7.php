<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="/">
                <i class="icon-head menu-icon"></i>
                <span class="menu-title">Margin Penjualan</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/">
        ...
        <li class="nav-item">
            <a class="nav-link" href="/">
                <i class="icon-head menu-icon"></i>
                <span class="menu-title">Detail Pengadaan</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/">
        ...
        <li class="nav-item">
            <a class="nav-link" href="/">
                <i class="icon-head menu-icon"></i>
                <span class="menu-title">Detail Penerimaan</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/">
        ...
        <li class="nav-item">
            <a class="nav-link" href="/">
                <i class="icon-head menu-icon"></i>
                <span class="menu-title">Detail Retur</span>
            </a>
        </li>
    </ul>
  </nav>
  <?php /**PATH S:\XAMPP\htdocs\laravel\PBD-S3\resources\views/shop/sidebar.blade.php ENDPATH**/ ?>